...
const OutputTable = () => {
    const {address, date, groupsNumber, groupsNumber2, submittedOfferNumber, submittedOfferNumber2, offerPendingNumber, offerPendingNumber2, responsePendingNumber, responsePendingNumber2, notInterestedNumber, notInterestedNumber2, notes} = useDataContext();
    ...
    return (
        <section className="flex flex-col justify-center items-center w-full mt-44">
            ...
            <table className="border-2 border-gray-200 border-collapse">
                <thead>
                <tr className="border-2 border-gray-200 *:border-2 [&>th:nth-child(2)]:text-sm [&>th:nth-child(2)]:font-normal [&>th:nth-child(3)]:text-sm [&>th:nth-child(3)]:font-normal">
