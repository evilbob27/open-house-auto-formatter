                ...
                <div className="mt-20 px-6 py-2">
                    <div className="flex flex-col my-2 items-start">
                        <label className="flex flex-col text-2xl font-semibold">
                            ...
                            <input className="text-lg font-normal border-2 border-gray-200 rounded-md px-1"
                                   ...
                                   placeholder="Address"
                            />
                            {errors.address && <div className="error-text">{errors.address.message}</div>}
                        </label>
                        <label className="flex flex-col text-2xl font-semibold mt-2">
                            Date
                            <input className="text-lg px-1"
                                {...register("date")}
                                type="date"
                                value={date}
                            />
                    ...
                    <div className="flex flex-col border-2 border-gray-300 rounded-md items-start my-2 px-6 py-4">
                        <label className="flex flex-col text-xl font-semibold">
                            ...
                            />
                            {errors.groupName && <div className="error-text">{errors.groupName.message}</div>}
                        </label>
                        ...
                        <div className="flex gap-2 mt-2">
                            ...
                            <label className="flex flex-col text-xl font-semibold">
                                ...
                                />
                                {errors.phoneNumber && <div className="error-text">{errors.phoneNumber.message}</div>}
                            </label>
                        </div>
                        ...
                        <div className="flex flex-col text-xl font-semibold mt-2">
                            ...
                            {errors.isRealtor && <div className="error-text">{errors.isRealtor.message}</div>}
                            {isRealtorValue === "yes" && (
                                <input
                            ...
                            {errors.realtor && <div className="error-text">{errors.realtor.message}</div>}
                        </div>
                    </div>
                </div>
